...
const NavList = () => (
  ...
  <div className="flex flex-col lg:flex-row w-full h-full justify-between">
    ...
    <div className="flex items-center gap-5">
      <CommonButton
        className="!p-0 text-light-grey-btn-color font-medium text-sm leading-5 !w-fit hover:text-light-grey-btn-color/70 duration-300 ease-in-out transition-all pointer-events-none"
      ...
      <CommonButton
        className="bg-extra-dark-danger-color text-white !px-3 !py-2 !rounded-full !text-sm !leading-5 !w-fit !ml-auto pointer-events-none"
