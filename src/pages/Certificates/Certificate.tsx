...
(
  <div className="flex flex-col h-full gap-8 pt-8">
    ...
    <div className="flex flex-col gap-5 justify-center items-center h-full">
      <DescriptionComponent className="font-bold! text-3xl text-primary-color!" singleLineContent={English.E55} />
      <DescriptionComponent className="text-base!" singleLineContent={English.E273} />
    </div>
    {/* <TabComponent
