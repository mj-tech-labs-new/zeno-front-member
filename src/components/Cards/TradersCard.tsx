  ...
  return (
    <OpacityContainer>
      <div className="card  overflow-hidden">
        <div className=" p-4 xl:p-8 bg-dark-gray-bg rounded-[26px] lg:p-[85px] lg:pr-0! grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-[49px]">
          ...
          <ImageComponent
            className="[&>img]:custom_shadow [&>img]:object-contain  lg:h-[440px]"
            imageUrl={mainImg}
          />
        </div>
      </div>
